<script lang="ts">
	...
	const searchUserValues = derived(
		[searchStore, userNameStore],
		([search, userNames]): { value: string; label: string }[] | undefined => {
...
{#if $addonUsersStore !== undefined}
	<div class="card card-body">
		<div class="header">
			...
			<span on:click={$allChecked ? clear : selectAll} on:keypress={() => {}}>
