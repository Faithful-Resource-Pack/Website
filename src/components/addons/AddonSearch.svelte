<script lang="ts">
	import { checkboxChoices, searchStore, CheckboxTypesValues, startStore } from "$stores/AddonStore";
    ...
    <div class="checkboxes">
        {#each $checkboxes as checkbox}
            <Checkbox
                ...
                on:change={() => {checkbox.toggle(checkbox.choice); startStore.startSearch()}}
                />
        {/each}
    </div>
