...
<div class="section green">
	<div>
		...
		<p>
			Faithful aims to re-create Minecraft's original textures in higher resolutions, while staying
		...
		<a
			...
			target="_blank"
			rel="noreferrer">JOIN OUR DISCORD<Fa icon={faAngleRight} /></a
		>
	</div>
	<img src="/images/about/1.png" alt="placeholder" />
</div>
<div class="section">
	...
	<div>
		...
		<p>
			As a community-run pack, all our textures are voted on before being added, and we prioritise
			community feedback above all.
			<br /><br />
			All our textures, as well as the code of all our related projects, are available on GitHub. Take
		...
		<a
			...
			target="_blank"
			rel="noreferrer">VISIT OUR GITHUB<Fa icon={faAngleRight} /></a
		>
	</div>
</div>
<div class="section blue">
	...
	<img src="/images/about/3.png" alt="placeholder" />
</div>
<div class="section">
	<img src="/images/about/2.png" alt="placeholder" />
	<div>
		...
		<a
			...
			target="_blank"
			rel="noreferrer">HOW TO CONTRIBUTE<Fa icon={faAngleRight} /></a
		>
	</div>
</div>
<div class="section pink">
	<div>
		<h1 class="normal">A HISTORY OF EXPERTISE</h1>
		<p>
			We've got over a decade of experience making quality textures for Minecraft, with a rich
			history spanning from the first posts up to today.
			<br /><br />
			Being one of the first ever texture packs to be developed, starting all the way back in 2010, Faithful
			has secured its place among the most well-known Minecraft projects.
		</p>
...
<div class="faq">
	...
	<a class="button button-theme" href="/faq">VIEW OUR FAQ<Fa icon={faAngleRight} /></a>
</div>
...
<style lang="scss">
	...
	.faq {
		...
		align-items: center;
		padding-top: 80px;
		// Only padding 30px and not 80px because the body already has a padding of 50px at the bottom
		padding-bottom: 30px;
