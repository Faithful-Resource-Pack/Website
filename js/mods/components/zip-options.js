...
const NAME = "Faithful Mods"; // eslint-disable-line

export default {
	name: "zip-options",
	components: {
		ClearDatabase: Vue.defineAsyncComponent(() => import("./clear-database.js")),
	},
	template: `
		<div id="zipOptions">
			<h4 class="my-3">
	...
	computed: {
		compressionLevels() {
			...
			for (let i = 0; i < this.compressionLevelsAvailable; ++i) {
				result.push({
					value: i,
					label:
						i in this.specialCompressionLabels
							? i + ` (${this.specialCompressionLabels[i]})`
							: String(i),
				});
			}
		...
		customArchiveName() {
			return this.advancedOptionsEnabled && this.archiveName !== ""
				? this.archiveName
				: undefined;
		},
	},
